...
#include "OrigDiffDrivePlugin.hh"
...
void DiffDrivePlugin::Load(physics::ModelPtr _model,
                           sdf::ElementPtr _sdf)
{
	gzwarn << "Loading plugin\n";
  this->model = _model;

	gzwarn << "Creating handle\n";
  this->node = transport::NodePtr(new transport::Node());
	gzwarn << "Initing handle\n";
